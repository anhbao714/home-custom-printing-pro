          ...
          <div className="primary w-full h-full">
            <div className="main w-full h-full flex justify-center items-center">
              <div className="my-account w-full h-full md:px-[115px] md:py-[90px] flex flex-col items-center justify-center">
                <div className="header-title w-full h-[40px] mb-2.5 text-[30px] text-[#67727d] font-bold text-left">
                  My account
                </div>
                <div className="wrap w-full h-[440px] md:h-[540px] flex flex-col justify-center items-center">
                  <div className="clear w-full h-[440px] md:h-[500px] flex justify-center items-center">
                    <div className="login md:w-[570px] h-full p-5 my-[15px] border-[1px] bg-slate-100 flex flex-col justify-center">
                      <h2 className="header w-full h-[55px] text-[25px] md:text-[42px] text-[#808285] my-[20px] md:mb-[60px] flex justify-center items-center">
                        Login
                      </h2>
                      <form action="" className="w-full">
                        <input
                          ...
                          required
                          className="User w-full h-[52.2px] border px-[13.6px] py-[15.3px]"
                        />
                        ...
                        <div className="me w-full h-[30px] flex items-center">
                          <input
                            type="checkbox"
                            name="Remember me"
                            className="Remember h-full w-[15px] mr-[5px]"
                            id="Remember me"
                          />
                          <div className="remember-me text-sm font-semibold text-[#67727d]">
                            Remember me
                          </div>
                        </div>

                        <button className="w-full h-[40px] my-[30px] border-2 border-black text-[#67727d]">
                          Log In
                        </button>
