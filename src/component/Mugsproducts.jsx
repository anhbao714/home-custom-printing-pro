    ...
    return (
       <div>
        <div className="body-container w-full h-full mt-[10px] lg:px-[150px] md:px-5 font-barlow ">
                  ...
                  <svg className="h-4 w-4 mr-2 text-gray-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64h384c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32h384c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32h384c17.7 0 32 14.3 32 32z"/></svg>
                  Filter
                    </button>
                    <p className="text-lg w-1/2 flex justify-end md:justify-start text-gray-500 md:ml-[10px] pr-2.5">Showing all 5 results</p>
                      </div>  
                      ...
                      <button className="flex lg:w-full items-center justify-between text-gray-500 text-lg p-2 w-[250px] border border-gray-300 ">
                           Default sorting
                          <svg className="h-4 w-4 text-gray-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <ul className="absolute left-[-1px] top-[37px] bg-white shadow-lg border w-[250px] z-[3] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                          <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-white">Default sorting</a></li>
                          <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-white">Sort by popularity</a></li>
                          <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-white">Sort by average rating</a></li>
                          <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-white">Sort by latest</a></li>
                          <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-white">Sort by price: low to high</a></li>
                          <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-white">Sort by price: high to low</a></li>
                        </ul>
                    </div>
                </div>

                    <div className="products">
                      <ul className="mugsproducts-columns w-full md:flex-wrap md:grid md:grid-cols-3 md:gap-x-4 md:gap-y-6">
                            ...
                            <div key={product.id} className="column product1-column w-full h-full px-2">
                                <div className="row img-product relative">
                                  ...
                                  <div onClick={() => {setIsOpen(true)
                                    setSelectedProduct(product);}}  className="overview z-1  w-full h-[30px] absolute bg-gray-700 cursor-pointer flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300 bottom-0">
                              ...
                              {product.sale ? (
                                       <>
                                         <div className="original-price line-through text-gray-400 mr-2">{product.originalPrice}</div>
                                         <div className="sale-price text-zinc-700">{product.salePrice}</div>
                                       </>
                                     ) : (
                                       <div className="sale-price text-zinc-700">{product.originalPrice}</div>
                                     )}
                                   </div>
                                </div>
                              </div>
