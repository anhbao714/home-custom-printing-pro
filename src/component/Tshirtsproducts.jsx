        ...
        <div>
            <div className="body-container w-full h-full mt-[10px] lg:px-[150px] md:px-5 font-barlow ">
                  ...
                  Filter
                    ...
                    <p className="text-lg w-1/2 flex justify-end md:justify-start text-gray-500 md:ml-[10px] pr-2.5">Showing all 6 results</p>
                      </div>  
                    ...
                    <ul className="tshirtsproducts-columns w-full md:flex-wrap md:grid md:grid-cols-3 md:gap-x-4 md:gap-y-6">
